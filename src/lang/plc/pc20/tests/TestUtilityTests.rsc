...
test bool testEqualLists()
    = expectEqual(sampleList, identicalList, "Identical lists return true");
test bool testListDifferentSize()
    = expectNotEqual(sampleList, differentSize, "Different size returns false");
test bool testListDifferentContent()
    = expectNotEqual(sampleList, differentContent, "Different content returns error");
