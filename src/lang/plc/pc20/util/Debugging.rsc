module lang::plc::pc20::util::Debugging
...
public
default &T debugPrint(str infoMessage, &T itemToPrint)
    = debugPrint(infoMessage, itemToPrint, true);
...
public
str fileTimeStamp()
    = replaceAll(replaceAll(replaceAll(timeStamp(), ":", ""), "-", ""), " ", "_");
