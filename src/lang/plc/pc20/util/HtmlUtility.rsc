module lang::plc::pc20::util::HtmlUtility
...
public
str testRow(str moduleName, str testName, bool testResult)
    = openRow() + testCell(testResult) + tableCell(moduleName) + tableCell(testName) + closeRow();
