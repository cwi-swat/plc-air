module lang::plc::pc20::util::InstructionUtility
...
str addressRange(&T firstPart, &T secondPart)
    = "<addressRange(firstPart)> to <addressRange(secondPart)>";
