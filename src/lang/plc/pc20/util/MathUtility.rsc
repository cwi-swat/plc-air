module lang::plc::pc20::util::MathUtility
...
int setBit(int intValue, int bitPosition)
    = resetBit(intValue, bitPosition) + shiftLeft(1, bitPosition);
int resetBit(int intValue, int bitPosition) = intValue - mask(intValue, shiftLeft(1, bitPosition));
int isBit(int intValue, int bitPosition, bool newValue)
    = (true == newValue) ? setBit(intValue, bitPosition) : resetBit(intValue, bitPosition);
